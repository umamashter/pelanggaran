...
.table-detail tbody tr:nth-child(even):hover td {
    background: #f1f5f9;
}
.badge-status-ms {
...
.badge-status-ms.hadir {
    background: #f0fdf4;
    color: #16a34a;
}
.badge-status-ms.izin {
    background: #fffbeb;
    color: #d97706;
}
.badge-status-ms.sakit {
    background: #fef2f2;
    color: #dc2626;
}
.badge-status-ms.alpha {
    background: #f1f5f9;
    color: #64748b;
}
.btn-kembali-ms {
...
@media (max-width: 768px) {
    ...
    .table-detail thead th { font-size: 11px; padding: 9px 8px; }
    .table-detail tbody td { padding: 8px; font-size: 12px; }
...
<div class="master-absensi-page">
    ...
    <div class="info-card-modern mb-4">
        <div class="info-item">
            ...
            <span><strong>Kelas :</strong> {{ $absensi->jadwal->kelas->nama_kelas }}</span>
        </div>
        <div class="info-item">
            <i class="fas fa-book"></i>
            <span><strong>Mapel :</strong> {{ $absensi->jadwal->mapel->nama_mapel }}</span>
        </div>
        <div class="info-item">
            <i class="fas fa-calendar-alt"></i>
            <span><strong>Tanggal :</strong> {{ \Carbon\Carbon::parse($absensi->tanggal)->translatedFormat('d F Y') }}</span>
        </div>
    </div>
