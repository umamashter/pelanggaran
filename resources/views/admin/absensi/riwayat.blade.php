...
.btn-header-ms.btn-rekap-ms {
    background: linear-gradient(135deg, #16a34a, #22c55e);
    color: #fff;
    box-shadow: 0 2px 8px rgba(22,163,74,.25);
}
.btn-header-ms.btn-rekap-ms:hover {
...
#riwayatTable tbody tr:last-child td {
    border-bottom: none;
}
#riwayatTable tbody tr:hover td {
    background: #f8fafc;
}
#riwayatTable tbody tr:nth-child(even) td {
    background: #fafbfc;
}
#riwayatTable tbody tr:nth-child(even):hover td {
    background: #f1f5f9;
}
...
.btn-aksi-ms.btn-info-ms {
    background: #eff6ff;
    color: #2563eb;
}
.btn-aksi-ms.btn-info-ms:hover {
    background: #2563eb;
    color: #fff;
    box-shadow: 0 3px 10px rgba(37,99,235,.3);
}
.btn-aksi-ms.btn-warning-ms {
    background: #fffbeb;
    color: #d97706;
}
.btn-aksi-ms.btn-warning-ms:hover {
    background: #d97706;
    color: #fff;
...
@media (max-width: 768px) {
    ...
    #riwayatTable thead th { font-size: 11px; padding: 9px 8px; }
    #riwayatTable tbody td { padding: 8px; font-size: 12px; }
    .header-icon { width: 44px; height: 44px; font-size: 20px; }
}
@media (max-width: 480px) {
    .table-card .card-body { padding: 8px 10px 12px; }
    #riwayatTable thead th { padding: 7px 5px; font-size: 10px; }
    #riwayatTable tbody td { padding: 7px 5px; font-size: 11px; }
    .btn-aksi-ms { width: 28px; height: 28px; font-size: 11px; }
    .dataTables_wrapper .dataTables_filter label input { width: 100%; }
}
</style>
                ...
                <table id="riwayatTable" class="table display" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $absensi->jadwal->guru->nama ?? '-' }}</td>
                            <td class="text-center">
                                <span class="badge-siswa-count">
                            ...
                            <td class="text-center">
                                <a href="{{ route('absensi.detail',$absensi->id) }}"
                                    class="btn-aksi-ms btn-info-ms"
                                    title="Detail">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('absensi.edit',$absensi->id) }}"
                                    class="btn-aksi-ms btn-warning-ms"
                                    title="Edit">
