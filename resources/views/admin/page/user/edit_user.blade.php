<div class="modal fade" id="myModal" tabindex="-1" role="dialog" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="padding: 16px 24px; background: linear-gradient(135deg, #d97706, #f59e0b);">
                <h4 class="modal-title text-white fw-bold" id="myModalLabel">Edit User</h4>
                <button class="btn btn-sm btn-dark text-warning" data-bs-target="#exampleModalToggle2"
