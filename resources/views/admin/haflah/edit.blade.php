    ...
    <div class="card border-0 shadow-sm" style="border-radius: 18px;">
        <div class="card-body p-4">
            ...
            <div class="d-flex align-items-center gap-3 mb-4 pb-3" style="border-bottom:1.5px solid #e2e8f0;">
                ...
                <div>
                    <h4 class="mb-0 fw-bold" style="color:var(--ms-text);font-size:20px;">Edit Haflatul Imtihan</h4>
                    <p class="mb-0" style="color:var(--ms-text-soft);font-size:13px;">Perbarui data penyelenggaraan haflatul imtihan</p>
                </div>
            </div>
            ...
            {{-- FORM --}}
            <form action="{{ route('haflatul-imtihan.update', $haflatul->id) }}" method="POST" onsubmit="return !this.submit.disabled && (this.submit.disabled=true, sessionStorage.setItem('sia_navigating','true'), true)">
                @csrf
                @method('PUT')
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group-cu">
                                ...
                                <select name="tahun_ajaran_id" class="form-select @error('tahun_ajaran_id') is-invalid @enderror">
                                    ...
                                    <option value="{{ $tahun->id }}" {{ old('tahun_ajaran_id', $haflatul->tahun_ajaran_id) == $tahun->id ? 'selected' : '' }}>{{ $tahun->tahun_ajaran }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="input-group-cu">
                                ...
                                <input type="text" name="nama_acara" class="form-control @error('nama_acara') is-invalid @enderror" value="{{ old('nama_acara', $haflatul->nama_acara) }}" placeholder="Contoh: Haflatul Imtihan dan Akhirussanah">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-cu">
                                ...
                                <input type="date" name="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" value="{{ old('tanggal_mulai', $haflatul->tanggal_mulai) }}">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group-cu">
                                <div class="input-group-cu-icon"><i class="fas fa-calendar"></i></div>
                                <input type="date" name="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" value="{{ old('tanggal_selesai', $haflatul->tanggal_selesai) }}">
                            </div>
