...
@push('css')
<style>
    .edit-sesi-page { font-family: 'Inter', 'Poppins', system-ui, sans-serif; max-width: 520px; margin: 22px auto 0; padding: 0 16px; }
    ...
    .btn-cu { height: 44px; padding: 0 28px; border-radius: 10px; font-size: 14px; font-weight: 600; display: inline-flex; align-items: center; gap: 8px; border: none; transition: all .25s; }
    ...
    <div class="card create-card">
        <div class="create-card-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 fw-bold" style="color:#1e293b;font-size:18px;">Edit Nama Sesi</h4>
                    <span style="font-size:13px;color:#64748b;">Ubah opsi nama sesi.</span>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('sesi.update', $sesi->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group-cu">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $sesi->nama) }}" placeholder="Cth: Hari 1 Pagi">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group-cu">
                        ...
                        <input type="date" name="tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal', $sesi->tanggal) }}">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group-cu">
                            ...
                            <input type="time" name="jam_mulai" class="form-control @error('jam_mulai') is-invalid @enderror" value="{{ old('jam_mulai', $sesi->jam_mulai) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group-cu">
                            ...
                            <input type="time" name="jam_selesai" class="form-control @error('jam_selesai') is-invalid @enderror" value="{{ old('jam_selesai', $sesi->jam_selesai) }}">
