...
<style>
    ...
    .input-group-cu .form-control[readonly] {
        background: #f1f5f9;
        cursor: not-allowed;
        color: #64748b;
    }

    .input-group-cu .form-control[readonly]:focus {
        border-color: #e2e8f0;
        box-shadow: none;
    }
    ...
    textarea.form-control+.input-group-cu-icon {
        top: 18px;
        transform: none;
    }
...
<div class="create-sesi-page">
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-cu">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('sesi-lomba.index') }}">Sesi Lomba</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Tambah Sesi Lomba</li>
        </ol>
    </nav>
    ...
    <div class="card create-card">
        <div class="create-card-header">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h4 class="mb-0 fw-bold" style="color: #1e293b; font-size: 18px;">Tambah Sesi Lomba</h4>
                    <span style="font-size: 13px; color: #64748b;">Buat sesi baru untuk jadwal lomba.</span>
                </div>
            </div>
        </div>
        ...
        <div class="create-card-body">
            ...
            <form action="{{ route('sesi-lomba.store') }}" method="POST">
                @csrf

                <div class="mb-4">
                    <label class="form-label-cu">Nama Acara</label>
                    <div class="input-group-cu">
                        <i class="fas fa-calendar-alt input-group-cu-icon"></i>
                        <input type="text" class="form-control" value="{{ $haflahAktif->nama_acara ?? '-' }}" disabled>
                    ...
                    <div style="font-size:12px;color:#94a3b8;margin-top:4px;">
                        <i class="fas fa-lock me-1"></i> Menggunakan haflatul imtihan yang sedang aktif
                    </div>
                    @endif
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <div class="input-group-cu">
                                ...
                                <input type="date" name="tanggal" id="input_tanggal" class="form-control @error('tanggal') is-invalid @enderror" value="{{ old('tanggal') }}" readonly onfocus="this.blur()">
                                @error('tanggal')
                                <div class="invalid-feedback-cu"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-4">
                            ...
                            <div class="input-group-cu">
                                ...
                                <input type="time" name="jam_mulai" id="jam_mulai" class="form-control @error('jam_mulai') is-invalid @enderror" value="{{ old('jam_mulai') }}" readonly onfocus="this.blur()">
                                @error('jam_mulai')
                                <div class="invalid-feedback-cu"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="mb-4">
                            ...
                            <div class="input-group-cu">
                                ...
                                <input type="time" name="jam_selesai" id="jam_selesai" class="form-control @error('jam_selesai') is-invalid @enderror" value="{{ old('jam_selesai') }}" readonly onfocus="this.blur()">
                                @error('jam_selesai')
                                <div class="invalid-feedback-cu"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group-cu">
                        ...
                        <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror" rows="4" placeholder="Masukkan keterangan sesi (opsional)" style="padding-left:42px;padding-top:12px;height:auto;">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                        <div class="invalid-feedback-cu"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-actions-cu">
                    <a href="{{ route('sesi-lomba.index') }}" class="btn btn-cu btn-cu-secondary">
