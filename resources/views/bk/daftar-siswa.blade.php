    ...
    <div class="card shadow px-0">
        <div class="card-header bg-gradient bg-success text-white">
            <h3 class="fw-bolder mt-2 d-inline-flex">
                List Siswa {{ $guru_bk->kelas->nama_kelas }}
            </h3>
        </div>
                ...
                <tbody>
                    @foreach ($siswas as $siswa)
                        <tr>
                            ...
                            <td><a @if ($siswa->poin == 0) class="text-success" @endif
                            ...
                            <td data-label="Posisi">
                                <a href="#modalCenter{{ $siswa->id }}" role="button"
                                    class="clickind btn btn-sm btn-info" data-bs-toggle="modal"><i
                                        class="fas fa-info"></i></a>
                                <a href="/bk/pelanggaran/tambah/{{ $siswa->nisn }}"
                                    class="clickind btn btn-sm btn-danger mb-1 animate__animated animate__flip"
                                    style="animation-delay: 2s;">
                                    <i class="fas fa-plus"></i></a>
                                <a href="/bk/pelanggaran/kurang/{{ $siswa->nisn }}"
