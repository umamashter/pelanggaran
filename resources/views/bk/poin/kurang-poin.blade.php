    ...
    <div class="card col-md-8">
        ...
        <div class="card-body">
            <form action="/bk/pelanggaran/kurang/{{ $siswa->id }}" method="post">
                ...
                <br>
                <div class="text-end">
                    <a href="/bk/daftar-siswa" class="btn btn-md btn-secondary btn-rounded me-1">Back</a>
                    <button class="btn btn-info show_confirm" data-toggle="tooltip" title='Delete' type="submit">
                        Kurang Poin
                    </button>
                </div>
            </form>
